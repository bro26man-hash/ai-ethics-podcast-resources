...
- **Known open debates:** See [DEBATES.md](./DEBATES.md) for the major thread on MetricFrame API design and who tools should serve (#756).
...
- **Last updated:** September 2026 — actively maintained
- **What it does:** A bias auditing and fairness toolkit designed for practical, real-world deployment. Aequitas focuses on generating audit reports that are interpretable by non-technical stakeholders — judges, policymakers, community members. It supports group fairness metrics and provides visualizations that make disparities visible.
...
|---------|-------|-------|------|
| [theashverse/ai-bias-dashboard](https://github.com/theashverse/ai-bias-dashboard) | — | Streamlit dashboard for fairness auditing with Gemini AI | [Link](https://github.com/theashverse/ai-bias-dashboard) |
